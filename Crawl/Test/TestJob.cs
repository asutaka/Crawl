    ...
    public class TestJob : IJob
    {
        ...
        public async static Task Handle()
        {
            ...
            try
            {
                ...
                await _page.GoToAsync($"https://infocom.vn/thanh-pho-ha-noi?page={pageIndex}", WaitUntilNavigation.Networkidle2);
                ...
                do
                {
                    ///html/body/div[2]/div/div[1]/div/div[34]/div/div/h3/a
