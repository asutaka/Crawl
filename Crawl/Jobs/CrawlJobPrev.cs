    ...
    public class CrawlJobPrev : IJob
    {
        public void Execute(IJobExecutionContext context)
        {
            ...
            using (var driver = new ChromeDriver(options))
            {
                ...
                {
                    NLogLogger.PublishException(ex, $"CrawlJobPrev.Execute|EXCEPTION| {ex.Message}");
                }
                ...
                foreach (var item in lstLink)
                {
                    ...
                    {
                        NLogLogger.PublishException(ex, $"CrawlJobPrev.Execute|EXCEPTION(Detail)| {ex.Message}");
                    }
                }
            }
